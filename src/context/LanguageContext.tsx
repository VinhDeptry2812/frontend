...
const translations: Translations = {
  ...
  'this_quarter': { vi: 'Quý này', en: 'This Quarter' },
  'this_year': { vi: 'Năm nay', en: 'This Year' },
  'day_mode': { vi: 'Theo Ngày', en: 'By Day' },
  'month_mode': { vi: 'Theo Tháng', en: 'By Month' },
  'quarter_mode': { vi: 'Theo Quý', en: 'By Quarter' },
  'year_mode': { vi: 'Theo Năm', en: 'By Year' },
  'select_year': { vi: 'Chọn năm', en: 'Select Year' },
  'select_month': { vi: 'Chọn tháng', en: 'Select Month' },
  'select_quarter': { vi: 'Chọn quý', en: 'Select Quarter' },
  'select_date': { vi: 'Chọn ngày', en: 'Select Date' },
  'avg_order_value': { vi: 'Giá trị TB / Đơn', en: 'Avg Order Value' },
  'total_orders_count': { vi: 'Tổng số đơn hàng', en: 'Total Orders' },
  'revenue_trend': { vi: 'Biểu đồ xu hướng doanh thu', en: 'Revenue Trend Chart' },
